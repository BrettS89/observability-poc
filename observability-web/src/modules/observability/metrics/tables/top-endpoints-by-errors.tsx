...
export type TopEndpointsByErrorsTableProps = {
  title?: string;
...
export function TopEndpointsByErrorTable(props: TopEndpointsByErrorsTableProps) {
  const {
    rows,
    onViewAll,
  } = props;
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ textAlign: "right", width: "15%" }}>Error Rate (%)</th>
